...
## Usage: "Rscript plot3.R"   (from bash)
##        "./plot3.R"         (from bash, with execute permission)
##        "source("plot3.R")" (from R)

## Plots a graph of energy sub meters in time from household power consumption
## dataset during 1st and 2nd of February 2007 to plot3.png file.
...
legend("topright", col = c("black", "#fb0007", "blue"), legend = names(dat)[7:9], lty = "solid")
